...
from secrets import AWS_ACCESS_KEY, AWS_SECRET_KEY, AWS_SESSION_TOKEN, BUCKET_NAME
...
ARQUIVO = 'nomes.csv'
S3_KEY = f'lab-glue/input/nomes.csv'
...
def upload_to_s3(arquivo, bucket_name, s3_key):
...
if __name__ == '__main__':
    upload_to_s3(ARQUIVO, BUCKET_NAME, S3_KEY)
